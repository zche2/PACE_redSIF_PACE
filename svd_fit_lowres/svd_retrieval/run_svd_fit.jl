...
#
# Usage:
#   julia -t 8 svd_fit_lowres/svd_retrieval/run_svd_fit.jl [path/to/global_fit_pipeline.toml]
...
"""Everything except [download], [general], [svd_retrieval] → in-memory retrieval dict."""
