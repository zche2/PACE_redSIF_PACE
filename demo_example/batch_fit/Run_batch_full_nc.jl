...
function _create_output_dataset(
    ...
    v_status = defVar(ds, "status_code", Int16, ("pixels", "scans"); comp...)
    v_steps = defVar(ds, "n_steps", Int16, ("pixels", "scans"); comp...)
    v_rmse = defVar(ds, "rmse", Float32, ("pixels", "scans"); comp...)
    v_rchi2 = defVar(ds, "reduced_chi2", Float32, ("pixels", "scans"); comp...)
    v_obj = defVar(ds, "objective", Float32, ("pixels", "scans"); comp...)
    ...
    v_dark = defVar(ds, "is_dark", UInt8, ("pixels", "scans"); comp...)
    v_ocean = defVar(ds, "is_ocean", UInt8, ("pixels", "scans"); comp...)
